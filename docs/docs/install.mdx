...
# Specify the version of Infrahub to run (for example, 1.5.0, stable, latest)
# Default: 1.5.0
INFRAHUB_VERSION=1.5.0
...
If schema loading fails with validation errors, ensure you're using a compatible version of Infrahub. This demo is tested with Infrahub 1.5.0 and later.
