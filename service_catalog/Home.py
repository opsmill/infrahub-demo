...
def main():
    ...
    try:
        with st.spinner(f"Loading colocation centers from branch '{st.session_state.selected_branch}'..."):
            colocations = client.get_objects("TopologyColocationCenter", st.session_state.selected_branch)
